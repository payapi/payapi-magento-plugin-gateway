...
use \Payapi\CheckoutPayment\Api\SecureFormGeneratorInterface;

class SecureFormGenerator extends \Magento\Framework\App\Action\Action implements SecureFormGeneratorInterface
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->isAjax()) {
            ...
            $secureformObject = $this->postSecureForm(
                $referenceQuoteId,
                $shippingExtraProd,
                $checkoutAddress,
                $ipaddress
    ...
    private function postSecureForm(
        $referenceQuoteId,
    ...
    private function completeQuoteAndGetData($quote, $shippingExtraProd, $checkoutAddress = false, $ipaddress = "")
    {
        ...
        if ($checkoutAddress) {
            ...
            if (!isset($finalAddr) || $finalAddr == null) {
                ...
                $region      = $this->scopeConfig->getValue('general/store_information/region');
                $finalAddr   = [
